...
caseInfo = ['Two hundred thousand','20萬筆資料','6萬筆資料','4萬筆資料','2萬筆資料']
databaseCollection = [{'database':'test','collection':'test1', 'Loops':5056},
                      {'database':'test','collection':'test2', 'Loops':5056},
                      {'database':'test','collection':'test3', 'Loops':1390},
